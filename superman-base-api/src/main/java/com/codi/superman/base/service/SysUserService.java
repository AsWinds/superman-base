...
public interface SysUserService {
     ...
     * @throws BaseAppException
     */
    int delUser(Long userId, Long adminUserId) throws BaseAppException;
     ...
     * @throws BaseAppException
     */
    SysUser getUser(String userCode) throws BaseAppException;
     ...
     * @throws BaseAppException
     */
    Long getUsersCount() throws BaseAppException;
     ...
     * @throws BaseAppException
     */
    List<SysUser> getUsers(Integer pageIndex, Integer pageSize) throws BaseAppException;
     ...
     * @throws BaseAppException
     */
    List<SysUser> getUsersByRoleId(Long roleId) throws BaseAppException;
     ...
     * @return
     */
    String getEncryptPwd(String userCode, String pwdText);
     ...
     * @return
     */
    int changePwd(String userCode, String oldPwdText, String newPwdText) throws BaseAppException;
